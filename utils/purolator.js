...
module.exports = async function purolatorData(trackingNumber) {
  ...
  return {
    ...
    attemptedDeliveryDate: data.shipments[0].originalEstimatedDeliveryDate,
    deliveryDate: data.shipments[0].originalEstimatedDeliveryDate,
    // events: events,
    origin:
      data.shipments[0].originInformation.address.city +
      ", " +
      data.shipments[0].originInformation.address.provinceStateCode,

    destination:
      data.shipments[0].destinationInformation.address.city +
      ", " +
      data.shipments[0].destinationInformation.address.provinceStateCode,
  };
};
